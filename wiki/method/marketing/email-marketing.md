...
## 2. Gửi giờ "lẻ" (odd send times)
Đừng gửi 11:00 — mọi brand hẹn giờ tròn → email bị chôn cùng lúc. Gửi **11:17** (giờ lẻ) để nổi giữa inbox. Chi phí 0, chỉ đổi schedule. *(giả định: hiệu lực giảm khi nhiều người bắt chước; lẻ-hoá là arbitrage tạm thời.)*
...
---
**Áp dụng MaxPro / pet store ($100k goal):** ưu tiên #1 (mystery discount abandonment) vì có data + dùng Klaviyo sẵn; #3/#4 là format swipe cho broadcast; #2/#5 là free tweak. Tất cả thuộc lever **owned/retention** — bổ trợ, không thay paid creative của [[ugly-ads-method]].
