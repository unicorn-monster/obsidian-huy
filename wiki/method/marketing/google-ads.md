...
- **Wide search coverage = 2 lớp:** (1) hiện ra cho NHIỀU query relevant nhất có thể; (2) chiếm NHIỀU vị trí nhất (top spots). Coverage kém = Shopping hiện vị trí 7-8 carousel / Search target 20 kw khi có 200 query relevant, nằm cuối trang. Mạnh = chiếm đa số query + top position + **chiếm phần lớn màn hình SERP**. Hai đầu phổ: brand DUY NHẤT hiện trên SERP vs brand ko hiện cả ở branded search của chính mình → feed duplication (đã có ở dưới) là đòn chiếm nhiều vị trí.
