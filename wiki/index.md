...
- [[email-marketing]] — owned/retention (Klaviyo): **mystery-discount > flat trong abandonment (data ~2× click, +46% order)**, odd send times (2 nguồn), pattern-interrupt + SMS-style email, resend top performer, **founder plain-text winback template**, **subscription 4-metric + billing-A/B −33% cancel**, **headline angle > copy (4-step framework)**, **popup personalization +21% signups (Prism AI)**, **10 lessons Chase Dimond $250M**, agency red-flags, **10 driver LTV thật (A/B testing ≠ nền — onboarding/identity/timing/unboxing)**, **email hero design 6-step + agency cadence**, **21-day 2-phase sub onboarding (Phase 1 skepticism kill → Phase 2 habit build + SMS D0/D3/D7)**. Nguồn Max Sturtevant + maxwellcopy.
