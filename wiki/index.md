...
- [[email-marketing]] — owned/retention (Klaviyo): **mystery-discount > flat trong abandonment (data ~2× click, +46% order)**, odd send times (2 nguồn), pattern-interrupt + SMS-style email, resend top performer, **founder plain-text winback template**, **subscription 4-metric + billing-A/B −33% cancel**, **headline angle > copy (4-step framework)**, **popup personalization +21% signups (Prism AI)**, **10 lessons Chase Dimond $250M**, agency red-flags, **10 driver LTV thật (A/B testing ≠ nền — onboarding/identity/timing/unboxing)**, **email hero design 6-step + agency cadence**, **21-day 2-phase sub onboarding (Phase 1 skepticism kill → Phase 2 habit build + SMS D0/D3/D7)**, **Day-30 rebill = highest churn day → tắt Shopify default email, rebuild Klaviyo với value reframe**, **Reach >> segmentation (9-figure data: wide 2M list 3x/week = 50-100% more rev; rule: list growth 3:1 > unsub trước khi layer segment)**. Nguồn Max Sturtevant + maxwellcopy.
- [[sms-flows]] — setup từng-flow 6 Klaviyo SMS flow (Welcome 3-msg · Site/Browse/Cart/Checkout abandonment · Win-back): trigger + exclusion-filter-ở-trigger + delay + quiet-hours + copy template + bảng tra nhanh + áp MaxPro. Tách setup khỏi tactic [[email-marketing]].
