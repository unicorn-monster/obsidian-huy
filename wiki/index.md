...
- [[funnel-and-landing]] — 5-stage funnel (creative→advertorial→presell→checkout→upsell) + pre-sell layer, proof-evaporation, AI page-clone
- [[presell-pages]] — build guide 4 format: wireframe, **listicle why+build (Reason-Why/Bencivenga/Primal Vikings)**, story-arc, CTA system, congruence, speed
